...
import 'package:jit_gaye_hackathon/screen/result/leafResultmew.dart';
...
class _SolutionState extends State<Solution> {
  ...
  uploadImage() async {
    ...
    final request = http.MultipartRequest(
        "POST", Uri.parse("https://74e1-14-99-167-142.ngrok-free.app/hello"));
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => LeafResultnew(
                  results: resJson['message'],
                )));
  }
